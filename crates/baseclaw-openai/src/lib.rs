//! OpenAI provider for the `BaseClaw` AI agent framework.
//!
...
//!
//! ```rust,no_run
//! use baseclaw_openai::{openai, structured::StructuredOutputProvider};
...
pub use baseclaw_openai_compat::{OpenAiCompatConfig, OpenAiCompatProvider};
