...
[![crates.io](https://img.shields.io/crates/v/baseclaw-rag.svg)](https://crates.io/crates/baseclaw-rag)
[![docs.rs](https://docs.rs/baseclaw-rag/badge.svg)](https://docs.rs/baseclaw-rag)

**RAG pipeline for BaseClaw — Retriever trait, grounding strategies, and BM25 keyword search.**
