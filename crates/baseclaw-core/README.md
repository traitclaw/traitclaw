...
[![crates.io](https://img.shields.io/crates/v/baseclaw-core.svg)](https://crates.io/crates/baseclaw-core)
[![docs.rs](https://docs.rs/baseclaw-core/badge.svg)](https://docs.rs/baseclaw-core)

**Core traits, types, and runtime for the BaseClaw AI Agent Framework.**

This crate provides the foundational building blocks that all BaseClaw crates depend on. Most users should use the [`baseclaw`](https://crates.io/crates/baseclaw) meta-crate instead of depending on this directly.
