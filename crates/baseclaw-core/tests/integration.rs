...
use baseclaw_core::types::model_info::{ModelInfo, ModelTier};
use baseclaw_core::types::stream::{CompletionStream, StreamEvent};
...
impl Provider for MockProvider {
    async fn complete(&self, _req: CompletionRequest) -> baseclaw_core::Result<CompletionResponse> {
    ...
    async fn stream(&self, _req: CompletionRequest) -> baseclaw_core::Result<CompletionStream> {
...
impl ErasedTool for GreetTool {
    ...
    fn schema(&self) -> baseclaw_core::traits::tool::ToolSchema {
        baseclaw_core::traits::tool::ToolSchema {
            name: "greet".into(),
    ...
    ) -> std::result::Result<serde_json::Value, baseclaw_core::Error> {
