//! Conversion between `traitclaw-core` types and the Anthropic Messages API format.
...
mod tests {
    ...
    fn make_request() -> CompletionRequest {
        traitclaw_core::types::completion::CompletionRequest {
