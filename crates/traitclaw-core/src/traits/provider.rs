...
///     async fn complete(&self, request: CompletionRequest) -> traitclaw_core::Result<CompletionResponse> {
///         todo!("Send request to LLM API")
///     }
///
///     async fn stream(&self, request: CompletionRequest) -> traitclaw_core::Result<CompletionStream> {
