//! Conversion helpers between `traitclaw-core` types and OpenAI wire format.
...
use traitclaw_core::{Error, Result, ToolSchema};

use crate::wire::{ChatRequest, ChatResponse, WireFunctionDef, WireMessage, WireTool};
use traitclaw_core::types::completion::CompletionRequest;
...
mod tests {
    use super::*;
    use traitclaw_core::types::completion::ResponseFormat;
