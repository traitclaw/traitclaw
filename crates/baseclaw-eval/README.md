...
[![crates.io](https://img.shields.io/crates/v/baseclaw-eval.svg)](https://crates.io/crates/baseclaw-eval)
[![docs.rs](https://docs.rs/baseclaw-eval/badge.svg)](https://docs.rs/baseclaw-eval)

**Evaluation framework for BaseClaw — test suites, metrics, and quality reports for AI agents.**
...
```rust
use baseclaw_eval::{EvalSuite, TestCase, KeywordMetric, LengthRelevancyMetric, Metric};
