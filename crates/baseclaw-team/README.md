...
[![crates.io](https://img.shields.io/crates/v/baseclaw-team.svg)](https://crates.io/crates/baseclaw-team)
[![docs.rs](https://docs.rs/baseclaw-team/badge.svg)](https://docs.rs/baseclaw-team)

**Multi-agent orchestration for BaseClaw — teams, role routing, delegation, and verification chains.**
