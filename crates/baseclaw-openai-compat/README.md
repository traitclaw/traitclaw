# baseclaw-openai-compat

[![crates.io](https://img.shields.io/crates/v/baseclaw-openai-compat.svg)](https://crates.io/crates/baseclaw-openai-compat)
[![docs.rs](https://docs.rs/baseclaw-openai-compat/badge.svg)](https://docs.rs/baseclaw-openai-compat)

**OpenAI-compatible provider for BaseClaw — works with OpenAI, Ollama, Groq, Mistral, vLLM, Azure, and any OpenAI-compatible API.**

This is the most versatile provider in the BaseClaw ecosystem. If your LLM exposes an OpenAI-compatible `/v1/chat/completions` endpoint, this crate will work.
